...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views from tbl_static where alias='kontak'";
$hasil = sql($perintah);
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/kontak/$gambar";
