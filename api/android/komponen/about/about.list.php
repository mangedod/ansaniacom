...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views from tbl_static where alias='about'";
$hasil = sql($perintah);
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/about/$gambar";
