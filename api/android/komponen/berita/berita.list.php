...
$sql = "select count(*) as jml from tbl_berita where published='1' and gambar!='' $where";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,secid,gambar,gambar1,views from tbl_berita where published='1' and gambar!='' $where order by id desc limit $start, $limit";
$hasil = sql( $mysql);
...
while ($data =  sql_fetch_data($hasil)) {	
	...
	$perintah = "select alias from tbl_berita_sec where secid='$secid'";
	$res = sql($perintah);
