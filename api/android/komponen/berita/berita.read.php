...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views,secid from tbl_berita where id='$id' and published='1'";
$hasil = sql($perintah);
...
$perintah = "select nama,alias from tbl_berita_sec where secid='$secid'";
$res = sql($perintah);
...
$url = "$fulldomain/berita/read/$secalias/$idcontent/$alias";
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/berita/$gambar";
...
$views = "update tbl_berita set views=views+1 where id='$id'";
$hsl = sql($views);
