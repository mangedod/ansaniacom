<?php
$perintah = "select secid,nama,alias from tbl_audio_sec where secid='$katid'";
$res = sql($perintah);
...
$sql = "select count(*) as jml from tbl_$kanal where proses='1' and secid='$secid'";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,secid,gambar,gambar1,audio,folder,waveform,userid,jmlcomment,views,durasi from tbl_$kanal where proses='1' and published='1' and secid='$secid' order by id  desc limit $ord, $judul_per_hlm";
$hasil = sql( $mysql);
