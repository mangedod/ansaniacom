...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views,secid from tbl_blog where id='$id' and published='1'";
$hasil = sql($perintah);
...
$perintah = "select nama,alias from tbl_blog_sec where secid='$secid'";
$res = sql($perintah);
...
$url = "$fulldomain/blog/read/$secalias/$idcontent/$alias";
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/blog/$gambar";
...
$views = "update tbl_blog set views=views+1 where id='$id'";
$hsl = sql($views);
