...
while ($row = sql_fetch_data($hsl))
{
	...
	$dt_keranjang[] = array("id"=>$id,"nama"=>$nama,"produkpostid"=>$produkpostid,"berat"=>$berat,"volume"=>$volume,"image_s"=>$image_s,"harga"=>$harga2,"qty"=>$qty,
...
$qrycart		= sql("select transaksiid, totaltagihan from tbl_transaksi where orderid='$orderid'");
...
$result['jml'] = $numprodup;
$result['datalist'] = $dt_keranjang;
$result["total_cart"] = $total_cart2;
$result["jumlah_cart"] = $jumlah_cart;	
$result['totaltagihan'] = $totaltagihan;
$result["totalberat"] = $totalberat;
$result["total_subtotal"] = $totaltagihan2;
$result["total_subtotalx"] =  $totaltagihan;
$result["totaltagihanakhir"] = $totaltagihanakhir2;
$result["total_subtotalxx"] = $totaltagihanakhir;
$result["jumlah_keranjang"] = $jumlah_keranjang;
$result["kodevoucher"] = $kodevoucher;
$result["namavoucher"] = $namavoucher;
$result["totaldiskonn"] = $totaldiskon;
$result["totaldiskon"] = $totaldiskon2;
$result["transaksiid"] = $transaksiid;
