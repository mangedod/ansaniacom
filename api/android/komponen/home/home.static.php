...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views from tbl_static where id='$id'";
$hasil = sql($perintah);
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/$alias/$gambar";
