...
if($subaksi=="populer") $urut = "order by views desc";
else $urut = "order by id desc";
...
$sql = "select count(*) as jml from tbl_audio where proses='1' $wherex";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,secid,gambar,gambar1,audio,folder,waveform,userid,jmlcomment,views,durasi from tbl_audio where proses='1' and published='1' $wherex order by id  desc limit $ord, $judul_per_hlm";
$hasil = sql( $mysql);
