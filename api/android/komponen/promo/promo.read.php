...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views from tbl_promo where id='$id' and published='1'";
$hasil = sql($perintah);
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/promo/$gambar";
...
$views = "update tbl_promo set views=views+1 where id='$id'";
$hsl = sql($views);
