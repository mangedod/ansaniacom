...
$sql = "select count(*) as jml from tbl_redeem where published='1' $where";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,gambar,gambar1,views from tbl_redeem where published='1' $where order by id asc limit $start, $limit";
$hasil = sql( $mysql);
