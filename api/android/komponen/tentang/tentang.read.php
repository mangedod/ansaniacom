...
$perintah = "select id,nama,ringkas,gambar,lengkap,create_date,alias,views from tbl_tentangseft where id='$id' and published='1'";
$hasil = sql($perintah);
...
if(!empty($gambar)) $detailgambar = "$fulldomain/gambar/tentangseft/$gambar";
...
$views = "update tbl_tentangseft set views=views+1 where id='$id'";
$hsl = sql($views);
