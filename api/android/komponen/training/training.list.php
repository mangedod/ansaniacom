...
$sql = "select count(*) as jml from tbl_training where published='1' $where";
$hsl = sql( $sql);
...
$mysql = "select secid,ringkas,nama,create_date,alias,gambar,gambar1,views from tbl_training where published='1' $where order by secid asc limit $start, $limit";
$hasil = sql( $mysql);
