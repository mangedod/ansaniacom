...
$sql = "select count(*) as jml from tbl_video where published='1' and gambar!='' $where";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,gambar,gambar1,views from tbl_video where published='1' and gambar!='' $where order by id desc limit $start, $limit";
$hasil = sql( $mysql);
