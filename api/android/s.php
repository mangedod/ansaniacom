...
require_once($lokasiweb.'librari/mandrill/src/Mandrill.php');
require_once($lokasiweb.'librari/gcm/gcm.php');*/
$path = str_replace("index.php","",$_SERVER['SCRIPT_FILENAME']);

$fulldomain = "https://www.craftnesia.id";
$basedomain = "https://www.dfunstation.id";
