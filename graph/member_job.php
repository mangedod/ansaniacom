...
while($row = mysql_fetch_object($query))
{
	...
	$sql1	= "select count(*) as jml from tbl_member where workId='$id' $where"; // like '%usercreateddate%'
...
// tidak diketahui
$sql2	= "select userId from tbl_member where workId=''";
