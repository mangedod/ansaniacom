...
if(sql_num_rows($hasil)>0)
{
	...
	<i style=\"display:block; height: $height"."px; width: $width"."px;  position: relative; z-index: 9; margin-top: -$height"."px;\"></i>
		...
		$C2 .= "<a href=\"$fulldomain/banner/lihat/$target\" target=\"_blank\"><img src=\"/gambar/banner/$gambar\" border=\"0\" width=\"$width\" height=\"$height\" class=\"img-responsive\" alt=\"\"/></a>";	
	}	
	$C2 .= "</span>";	
}
