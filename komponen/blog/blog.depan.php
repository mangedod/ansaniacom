<?php
//Pojok Muslimah
$mysql = "select id,ringkas,nama,create_date,alias,gambar,secid,userid from tbl_blog where published='1' and userid='0' order by id desc limit 3";
$hasil = sql($mysql);
