...
// if (empty($aksi)) $aksi = "read";
	...
	$sql = "select id,nama,ringkas,lengkap,oleh,alias,gambar,gambar1 from tbl_static where alias='disclaimer'";
	$hsl = sql($sql);
	...
	$tpl->assign("discnama",$nama);
	$tpl->assign("discringkas",$ringkas);
	$tpl->assign("disclengkap",$lengkap);
