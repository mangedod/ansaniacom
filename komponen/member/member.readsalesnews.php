...
/*if(!empty($katid))
{
	$perintah1 = "select * from tbl_newssales_sec where alias='$katid'";
...
$perintah = "select id,nama,oleh,ringkas,lengkap,gambar1,gambar,create_date,alias,views,userid from tbl_newssales where id='$id'";// and userid='$_SESSION[useridresel]'
$hasil = sql($perintah);
...
if(!empty($gambar)) $tpl->assign("detailgambar","$fulldomain/gambar/salesnews/$gambar");
if(!empty($gambarshare)) $tpl->assign("detailgambarshare","$fulldomain/gambar/salesnews/$gambarshare");
