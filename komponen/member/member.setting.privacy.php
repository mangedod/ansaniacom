...
if(isset($_POST['submit']))
{
	...
	$query= "update tbl_member set pvprofile='$pvprofile',pvbirth='$pvbirth',pvemail='$pvemail',pvaddress='$pvaddress',
			pvphonegsm='$pvphonegsm',pvmessage='$pvmessage' where username='$_SESSION[usernameresel]'";
	$hasil = sql($query);
...
$perintah = sql("select pvprofile,pvbirth,pvemail,pvaddress,pvphonegsm,pvmessage from tbl_member where username='$_SESSION[usernameresel]'");
