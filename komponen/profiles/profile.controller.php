...
$tpl->assign("title","$userfullname di SalingSapa.com ");

$tpl->assign("aksi",$aksi);


if((!$fb) and $aksi=="" or $aksi=="listpost" or $aksi=="readpost" or $aksi=="post") { include "./komponen/member/member.post.php"; }
...
if($tipe != 0)
	$tpl->display("profile-ulama.html");
else
