...
if(!empty($file1)){ $tpl->assign("extfile1",$extfile1); $tpl->assign("namafile1",$namafile1); $tpl->assign("file1","$fulldomain/gambar/$kanal/upload/$file1"); } 
if(!empty($file2)){ $tpl->assign("extfile2",$extfile2); $tpl->assign("namafile2",$namafile2); $tpl->assign("file2","$fulldomain/gambar/$kanal/upload/$file2"); } 
