...
else
{
	...
	if(!empty($gambar)) $tpl->assign("detailgambar","$fulldomain/gambar/$tipe/$gambar");
	if(!empty($gambarshare)) $tpl->assign("detailgambarshare","$fulldomain/gambar/$tipe/$gambarshare");
