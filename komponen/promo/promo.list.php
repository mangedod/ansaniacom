...
$sql = "select count(*) as jml from tbl_promo where published='1' $where";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,gambar,gambar1 from tbl_promo where published='1' order by id  asc limit $ord, $judul_per_hlm";
$hasil = sql( $mysql);
