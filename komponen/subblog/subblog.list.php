...
$sql = "select count(*) as jml from tbl_$kanal where published='1' and (userid='0' or userid='$contactid') $where";
$hsl = sql( $sql);
...
$mysql = "select id,ringkas,nama,create_date,alias,secid,gambar,gambar1 from tbl_$kanal where published='1' and (userid='0' or userid='$contactid') $where order by id  desc limit $ord, $judul_per_hlm";
$hasil = sql( $mysql);
