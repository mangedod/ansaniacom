...
if(file_exists($lokasiweb."/komponen/subcontactmessage/subcontactmessage.$aksi.php")) include("subcontactmessage.$aksi.php");
else{ $aksi = "list";  include("subcontactmessage.list.php"); }
