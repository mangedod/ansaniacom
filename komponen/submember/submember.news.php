<?php
	...
	$rn = sql_fetch_data($qn);
		...
		if(!empty($detailgambar)) $detailgambar = "$fulldomain/gambar/member-news/$detailgambar";
		else $detailgambar = "";
		
		if(!empty($detailgambar1)) $detailgambar1 = "$fulldomain/gambar/member-news/$detailgambar1";
		else $detailgambar1 = "";
