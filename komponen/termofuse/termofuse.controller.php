...
// if (empty($aksi)) $aksi = "read";
	...
	$sql = "select id,nama,ringkas,lengkap,oleh,alias,gambar,gambar1 from tbl_static where alias='aturanpengguna'";
	$hsl = sql($sql);
	...
	$tpl->assign("termofusenama",$nama);
	$tpl->assign("termofuseringkas",$ringkas);
	$tpl->assign("termofuselengkap",$lengkap);
