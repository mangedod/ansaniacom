...
$sql = "select count(*) as jml from tbl_$kanal where published='1'";
$hsl = sql( $sql);
...
$mysql = "select id,testimoni,nama,create_date,company,gambar,userid from tbl_$kanal where published='1' order by id  desc limit $ord, $judul_per_hlm";
$hasil = sql( $mysql);
