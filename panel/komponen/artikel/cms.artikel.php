...
else
{
	...
	if($aksi=="view")
	{
		...
		else
        {
			...
			$cari[] = array("secid","Kategori","find","find","index.php?pop=1&kanal=artikel&aksi=popsecid");
	...
	if($aksi=="tambah")
	{
		...
		else
        {
			...
			<script>	
				...
				function popsecid()
				{
					 var res = window.showModalDialog("index.php?pop=1&kanal=artikel&aksi=popsecid","", "dialogWidth:600px;dialogHeight:500px;dialogTop:200px;")
						if (res != null) {
