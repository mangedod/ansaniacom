...
$nama_tabel		= "tbl_customdesignjenis";
$judul_per_hlm 	= 25;
...
else
{
	...
	if($aksi=="view")
	{
		...
		else
        {
			...
			print("<th width=20%><a href=\"$urlorder&order=nama\" title=\"Urutkan\">Nama Bahan</a></th>\n");
			print("<th width=55%><a href=\"$urlorder&order=nama\" title=\"Urutkan\">Ringkas Bahan</a></th>\n");
	...
	if($aksi=="detail")
	{
		...
		else
        {
			...
			<table border="0" class="tabel-cms" width="100%">
				...
				<tr> 
					<td valign="top" width="20%" class="tdinfo">Nama Bahan</td> 
	...
	if($aksi=="savetambah")
	{
		...
		else
        {
			...
			$perintah = "insert into $nama_tabel(id,nama,alias,ringkas,lengkap,oleh,create_date,create_userid $fgambar $ffile1 $ffile2) 
