...
$nama_tabel		= "tbl_galeri_sec";
$nama_tabel1	= "tbl_galeri";
$judul_per_hlm 	= 25;
	...
	if($aksi=="view")
	{
		...
		else
        {
			...
			while ($row = sql_fetch_data($hsl))
			{
				...
				print("<td valign=top class=hitam><a href=\"$alamat&aksi=viewgaleri&secid=$secid\"><b>$jmlphoto Photos</b></a></td>\n");
				print("<td>");
