...
else
{
	...
	if($aksi=="view")
	{
		...
		else
		{
			...
			print("<th width=50%>Katerangan</th>\n");
	...
	if($aksi=="hapus")
	{
		...
		else
		{
			...
			$perintah = "delete from $nama_tabel1 where secid='$id'";
			$hasil = sql($perintah);
	...
	if($aksi=="savetambahcateg")
	{
		...
		else
		{
			...
			$perintah = "INSERT INTO $nama_tabel1 (`subid`,`secid`,`nama`,`alias`,`keterangan`) 
								VALUES ('$new','$secid','$nama','$alias','$keterangan')";
			$hasil = sql($perintah);
	...
	if($aksi=="savetambah")
	{
		...
		else
		{
			...
			$perintah = "INSERT INTO $nama_tabel (`secid`,`nama`,`alias`,`keterangan`) 
								VALUES ('$new','$nama','$alias','$keterangan')";
			$hasil = sql($perintah);
	...
	if($aksi=="saveeditcateg")
	{
		...
		else
		{
			...
			$perintah 	= "update $nama_tabel1 SET nama='$nama',alias='$alias',keterangan='$keterangan' WHERE secid='$secid' and subid='$subid'";
			$hasil = sql($perintah);
	...
	if($aksi=="saveedit")
	{
		...
		else
		{
			...
			$perintah 	= "update $nama_tabel SET nama='$nama',alias='$alias',keterangan='$keterangan' WHERE secid='$secid'";
			$hasil = sql($perintah);
