...
else
{
	...
	if($aksi=="view")
	{
		...
		else
        {
			...
			print("<th width=45% ><a href=\"$urlorder&order=url\" title=\"Urutkan\">URL Share</a></th>");
			...
			while ($row = sql_fetch_data($hsl))
			{
				...
				$share = "$fulldomain/l/$alias/";

				$url = substr($url,0,50)."...";

				$views = sql_get_var("select count(*) as jml from tbl_link_log where id='$id'");
				...
				print("<td valign=top class=hitam>$share</td>\n");
