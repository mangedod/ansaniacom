...
else
{
	...
	if($aksi=="view")
	{
        ...
        {
			$mainmenu[] = array("Lihat Transaksi Invoice","lihat","$alamat&aksi=view");
			...
			$where = $formcari[0]['where']." and status='1'";
		...
		else
        {
            ...
            <table border="0" class="tabel-cms" width="100%">
				...
				<tr> 
					...
					<td align="left">
                        <input type="button" onclick="javascript:window.location='<?php echo"index.php?tab=$tab&tabsub=9&kanal=konfirmasi&transaksiid=$transaksiid";?>'" value="Konfirmasi">
                        <input type="button" onclick="javascript:window.location='<?php echo"$alamat&aksi=batal&transaksiid=$transaksiid";?>'" value="Batal">
					</td>
				</tr>
			</table>
	...
	if($aksi=="batal")
	{
		...
		else
        {
			...
			$sql1	= "select invoiceid,userid,orderid from $nama_tabel where transaksiid='$transaksiid'";
			$query1	= sql($sql1);
			...
			<table border="0" class="tabel-cms" width="100%">
				...
				<tr> 
					...
					<td width="471"><input name="subject" type="text" size="20" value="Pembatalan Transaksi" id="subject" class="validate[required]" /></td>
				</tr>
                <tr> 
					<td width="176">Pesan</td>
					<td width="471">
                    	<textarea name="lengkap" cols="70" rows="10" id="lengkap" class="ckeditor validate[required]" >
                    		Dear <?php echo $nama?>,<br /><br />
	...
	if($aksi=="saveverifikasi")
	{
		...
		else
        {
			...
			else
			{
				...
				$userFullName		= "$nama"; 
				$headers 			= "From : $owner";
				$subject			= "$title, Pembatalan metode pembayaran COD";
                ...
                <tr class="info" style="display:none"> 
					...
					<td width="471">
                    	<textarea name="lengkap" cols="70" rows="10" id="lengkap" class="ckeditor validate[required]" >
                            ...
                            Kota Tujuan Anda tidak dicover oleh kami. Anda dapat mengubah metode pembayaran dengan mengklik URL dibawah ini:<br /><br />
                            
                            <a href="<?php echo $fulldomain?>/cart/pembayaran/<?php echo $kodeinvoice?>">Ubah Metode Bayar</a><br /><br />
